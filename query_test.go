...
func TestBigQuery(t *testing.T) {
	...
	q.Paginate(CountFirst, ErrorMessageField, 1)
	q.Paginate(CountFirst, ErrorTimeField, 1)
	q.Paginate(CountFirst, ErrorErrorTypeField, 1)
	q.Paginate(CountAfter, ErrorMessageField, 1)
	q.Order(Ascending, ErrorMessageField, ErrorTimeField)
	q.Paginate(CountFirst, ErrorMessageField+ErrorMessageField, 1)
